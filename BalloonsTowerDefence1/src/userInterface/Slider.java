...
public class Slider {
	...
	private int sliderBarX, sliderBarY, sliderPointerX, sliderPointerY, width, height, sliderBarWidth, min, max, step,
			currentValue, x, y, pointerHeight, pointerWidth, pointerPos = 0;
...
//		sliderMenu.addMenuSlider("", barTexture, pointerTexture, minVal, maxVal, step, pointerPos);
